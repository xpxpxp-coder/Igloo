                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Snowman Command
                        Center will restart to finish recovery. Or go back to
                        start a new identity with a fresh key.
                      </p>
                    </>
                  ) : (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Snowman Command Center. If this key already has a
                        profile on the relay, your name and avatar are restored
                        automatically.
                      </p>
                    </>
                  )}
