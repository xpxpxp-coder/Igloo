  ...
  lifecycle {
    ...
    precondition {
      condition = (
        ...
        (var.relay_desired_count == 0 && var.worker_desired_count == 0 && var.scheduler_desired_count == 0 && var.trigger_desired_count == 0 && var.reminder_desired_count == 0 && var.model_gateway_desired_count == 0)
      )
