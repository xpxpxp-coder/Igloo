...
- Set `SNOWMAN_COMMAND_CENTER_IMAGE` to a Snowman-owned immutable digest such as `ghcr.io/snowman-ai-org/snowman-command-center@sha256:<digest>`. Mutable tags and upstream images are rejected for production.
